...
const DuemergePaynmentModal = ({
  ...
  useEffect(() => {
    if (orderDetails.length > 0) {
      ...
      // Update the paid amount state with the formatted value
      setPaidAmount(calculatedAmount); // Format to 2 decimal places
    }
...
export default DuemergePaynmentModal
